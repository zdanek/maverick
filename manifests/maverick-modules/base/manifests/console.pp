class base::console {
    ...
    file { [ "/etc/update-motd.d/00-header", "/etc/update-motd.d/10-help-text", "/etc/update-motd.d/50-motd-news", "/etc/update-motd.d/51-cloudguest", "/etc/update-motd.d/60-unminimize", "/etc/update-motd.d/80-livepatch" ]:
        ensure      => absent
    }
    file { "/etc/legal":
        ensure      => absent
