...
#   Set the active default locale, in Debian/Ubuntu format.
# @param locales
#   Any additional locales to be installed, so they can be also activated.
# @param timezone
#   The system timezone.
# @param language_pack
#   By default this is locales-all, which includes all the OS locales.  This can be set to specific locales but can cause problems.  If space is not a problem, leave as locales-all.
#
class base::locale (
