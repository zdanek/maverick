class maverick_dronekit::sitl (
    ...
    file { "/srv/maverick/data/config/mavproxy-sitl.conf":
        ...
        source      => "puppet:///modules/maverick_dronekit/mavproxy-sitl.conf",
    } ->
    file { "/srv/maverick/software/maverick/bin/mavproxy-sitl.sh":
        ensure      => link,
        target      => "/srv/maverick/software/maverick/manifests/maverick-modules/maverick_dronekit/files/mavproxy-sitl.sh",
    } ->
    file { "/etc/systemd/system/dev-sitl.service":
        content     => template("maverick_dronekit/dev-sitl.service.erb"),
        owner       => "root",
        group       => "root",
        mode        => 644,
    ...
    file { "/etc/systemd/system/mavproxy-sitl.service":
        content     => template("maverick_dronekit/mavproxy-sitl.service.erb"),
        owner       => "root",
        group       => "root",
        mode        => 644,
