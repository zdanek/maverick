...
/usr/bin/screen -c /srv/maverick/config/mavlink/mavproxy-$1.screen.conf -S $SCREEN_NAME -D -m /usr/local/bin/mavproxy.py --master $MAVPROXY_PORT --baud $MAVPROXY_BAUD --state-basedir=/srv/maverick/var/log/mavlink-$1 $MAVPROXY_ARGS
