...
class maverick_vision::vision_landing (
    ...
    exec { "vision_landing-compile":
        ...
        command     => "/usr/bin/cmake -DCUDA_TOOLKIT_ROOT_DIR=/usr/local/cuda-10.2 -Daruco_DIR=/srv/maverick/software/aruco -DOpenCV_DIR=/srv/maverick/software/opencv -DCMAKE_INSTALL_RPATH=/srv/maverick/software/aruco/lib:/srv/maverick/software/opencv/lib -DCMAKE_MODULE_PATH=/srv/maverick/software/opencv:/srv/maverick/software/aruco . && make && make install",
